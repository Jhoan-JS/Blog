...
(function(jQuery) {
    ...
    $('[data-extra-toggle="delete"]').on('click', function (e) {
        ...
        const postId = $(this).attr('data-id'); // ID del post a eliminar
        console.log(postId);
        ...
        .then((willDelete) => {
            if (willDelete.isConfirmed) {
                axios.delete('/api/v1/posts/delete', { data: { id: postId } })
            .then(response => {
                swalWithBootstrapButtons.fire({
                    title: '¡Borrado!',
                    text: "Tu entrada ha sido borrada.",
                    icon: 'success',
                    showClass: {
                        popup: 'animate__animated animate__zoomIn'
                    },
            ...
            .catch(error => {
                swalWithBootstrapButtons.fire({
                    title: 'Error',
                    text: "Hubo un problema al intentar eliminar la entrada.",
                    icon: 'error',
                    showClass: {
                        popup: 'animate__animated animate__zoomIn'
                    },
